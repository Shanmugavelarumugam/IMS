        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '30px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center', marginBottom: '28px' }}>
            ...
            <div>
              ...
              <span className="type-pill type-key" style={{ marginTop: '6px' }}>
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              >
                {selectedCustomer.currentBalance > 0 && util > 0.7 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.9rem', color: '#1e293b', fontWeight: 650, marginTop: '2px' }}>
          ...
          <div>
            ...
            {selectedCustomer.ledger.length === 0 ? (
              <p style={{ color: '#94a3b8', fontSize: '0.85rem', fontStyle: 'italic', margin: 0 }}>
                No transaction history on ledger.
              </p>
            ) : (
              <div className="ledger-timeline">
                {selectedCustomer.ledger.map((item) => (
                  <div
                    key={item.id}
                    className={`ledger-item ${item.isCredit ? 'credit' : 'debit'}`}
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
